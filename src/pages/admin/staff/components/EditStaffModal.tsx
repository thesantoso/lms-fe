...
interface EditStaffModalProps {
  isOpen: boolean;
  onClose: () => void;
  staff: any; // Using any for now to match mock data structure
  onSuccess?: () => void;
}
...
const EditStaffModal: React.FC<EditStaffModalProps> = ({ isOpen, onClose, staff, onSuccess }) => {
  ...
  useEffect(() => {
    if (staff && isOpen) {
      ...
      // Split RT/RW if available
      // const [rt, rw] = staff.rt_rw ? staff.rt_rw.split('/') : ['', ''];

      setFormData({
        photo: null,
        employeeId: staff.employeeId || staff.nip || '',
        nik: staff.nik || '',
        firstName: firstName,
        lastName: lastName,
        birthPlace: staff.birthPlace || '',
        birthDate: staff.birthDate ? convertDate(staff.birthDate) : '',
        gender: staff.gender || 'Laki - laki',
        religion: staff.religion || '',
        lastEducation: staff.lastEducation || '',
        address: staff.address || '',
        rt: staff.rt || '',
        rw: staff.rw || '',
        province: staff.province || '',
        regency: staff.regency || '',
        ...
        joinDate: staff.joinDate ? convertDate(staff.joinDate) : '',
        role: staff.role || '',
        modules: staff.modules ? (Array.isArray(staff.modules) ? staff.modules : staff.modules.split(', ')) : [],
      });
  ...
  // Helper to convert DD/MM/YYYY or DD Month YYYY to YYYY-MM-DD for input type="date"
