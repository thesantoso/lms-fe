...
import SchedulesPage from './pages/admin/master/SchedulesPage';
          ...
          <TenantProvider>
            <Routes>
              ...
              >
                ...
                <Route path="master/schedules" element={<SchedulesPage />} />
                <Route path="master/schedules/:classId" element={<ScheduleDetailPage />} />
